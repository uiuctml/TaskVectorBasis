...
def parse_arguments():
    ...
    parser.add_argument(
        "--data-location",
        type=str,
        default = '/data-3/common/cindy2000_sh/tangent_task_arithmetic/data',
    ...
    parser.add_argument(
        "--finetuning-mode",
        choices=["standard", "linear", "posthoc", "none","basis","linearbasis","mtl","continual"],
        help="Whether to use linearized models or not.",
    )
    parser.add_argument(
        "--mergeB",
        choices=["mean","topk","ties"],
        help="Second stage merging method.",
    )
    parser.add_argument(
        "--n-eval-points",
        type=int,
    ...
    parser.add_argument(
        "--pretrain_openclip_ckpt_name",
        type=str,
        help="use which open clip checkpoint, see https://github.com/mlfoundations/open_clip/discussions/812"
    )
